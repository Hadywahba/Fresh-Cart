...
export default function Navbar() {
 ...
 <nav className="bg-[rgb(242,242,248)]  dark:bg-gray-900  ">
  <div className="  container mx-auto flex max-w-screen-2xl flex-wrap items-center justify-between p-4">
   ...
   {Token ?    <ul className="font-xl gap-2 bg-[rgb(242,242,248)] flex flex-col items-center justify-center p-4 md:p-0 mt-4 border  rounded-lg  md:flex-row  md:space-x-4 rtl:space-x-reverse md:mt-0 md:border-0  ">
        <li>
