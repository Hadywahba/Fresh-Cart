      ...
      <nav className="bg-[rgb(242,242,248)]  dark:bg-gray-900  ">
        <div className="  container mx-auto flex max-w-screen-2xl flex-wrap items-center justify-between p-4">
          <div className="flex justify-center items-center gap-8 z-50 ">
            ...
            <div className="hidden w-full absolute md:relative md:top-0 top-[56px]  left-0 md:block md:w-auto" id="navbar-default">
              {Token ?  
              <>
              { openbutton && <ul className="font-xl gap-2 bg-[rgb(242,242,248)] flex flex-col items-center justify-center p-4 md:p-0 mt-4 border  rounded-lg  md:flex-row  md:space-x-4 rtl:space-x-reverse md:mt-0 md:border-0  ">
                <li>
                  <NavLink to={''} className="block  text-gray-900  " aria-current="page">Home</NavLink>
                </li>

                <li>
                  <NavLink to={'Products'} className="block   text-gray-900   ">Products</NavLink>
                </li>
                <li>
                  <NavLink to={'Categories'} className="block   text-gray-900  ">Categories</NavLink>
                </li>
                <li>
                  <NavLink to={'Brands'} className="block  text-gray-900    ">Brands</NavLink>
                </li>
