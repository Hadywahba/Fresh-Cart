      ...
      <div className="container mx-auto flex-grow px-8 py-10">
            ...
            <form className=" mx-auto">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="search"
                  id="default-search"
                  className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-main focus:border-main dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-main dark:focus:border-main"
        ...
        <div className="flex justify-center px-3 items-center md:flex md:justify-end md:items-center gap-3">
          <label htmlFor="productSelector">
            <i className="fa-solid fa-filter text-3xl text-main "></i>
          </label>
          <select
            onChange={handleSort}
            defaultValue={sort}
            className="border-main p-2 text-black rounded-md"
            name=""
            id="productSelector "
          >
            ...
            <option value="-ratingsAverage" className="text-black ">
              Top Rated
            </option>
        ...
        {product.length != 0 ? (
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6  gap-9  mt-5 px-4  ">
            {product?.map((product) => {
              ...
              return (
                <div key={product.id} className="product mb-8  ">
                  <div className="relative">
                    <button
                      className="absolute right-7 top-5 text-xl z-50"
                      onClick={() =>
                        favourite
                    ...
                    >
                      <i
                        className={`fa-solid fa-heart ${
                          favourite ? "text-red-600" : " text-gray-900"
                        } bg-violet-300 p-1`}
                      ></i>
                    </button>
                    <Link
