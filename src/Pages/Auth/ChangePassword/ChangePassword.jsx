...
export default function ChangePassword() {
  ...
  return (
    <div className="container mx-auto flex-grow px-8 py-26 md:py-24">
      <h1 className="text-center text-main text-3xl pt-16 mb-6">
        Reset Your Password
      </h1>
      <form
        onSubmit={NewPasswordformik.handleSubmit}
        className="mx-auto max-w-2xl px-8 pb-4"
      >
        <div className="relative z-0 w-full mb-8 group">
          <input
            ...
            name="email"
            id="floating_email"
            className="block mb-4 py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-main focus:outline-none focus:ring-0 focus:border-main peer"
            placeholder="  "
            required
          />
          <label
          ...
          {NewPasswordformik.errors.email && NewPasswordformik.touched.email ? (
            <div
          ...
          <div className="flex justify-center mt-8">
            <button
              type="submit"
              className="bg-main  p-4 rounded-md text-white w-[60%] text-xl   "
            >
              {loading ? (
