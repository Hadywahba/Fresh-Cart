  ...
  async function registerApi(values) {
    try {
      ...
      if (data.message == "success") {
        toast("Your Registration is successfully ", {
          theme: "light",
          type: "success",
          position: "top-center",
        });
  ...
  return (
    <div className="container mx-auto flex-grow px-8 py-24 md:py-24">
      <form
        ...
        className="mx-auto max-w-2xl px-8 py-14"
      >
        <h1 className="text-main text-3xl sm:text-5xl text-center font-semibold pt-6">
          Register Now
        </h1>
        {ApiError ? (
          <div
        ...
        <div className="relative z-0 w-full my-2 group">
          <input
            ...
            name="name"
            id="floating_name"
            className="block py-2.5 px-0  w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-main dark:focus:border-main focus:outline-none focus:ring-0 focus:border-main peer"
            placeholder="  "
            required
          />
          <label
        ...
        {isCallingApi ? (
          ...
          <button
            type="submit"
            className="text-white block ms-auto bg-main hover:bg-main focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-main dark:hover:bg-main dark:focus:ring-main"
          >
            Submit
          </button>
        )}
