...
import { OrderContext } from "../../../components/context/Order/OrderContex";
  ...
  async function paymentWays(values) {
    try {
      ...
      if (checkpayment) {
        ...
        navigate("/Allorders");
        toast("we are getting your order ready to be shipped", {
          theme: "dark",
          type: "success",
      ...
      >
        <div className="relative z-0 w-full mb-5 group">
          ...
          {paymentFormik.errors.details && paymentFormik.touched.details ? (
            <div
              className="flex items-center mt-2 p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300"
              role="alert"
            >
              <svg
        ...
        <button
          type="submit"
          className="text-white inline-block w-full bg-main hover:bg-main focus:ring-4 focus:outline-none focus:ring-main font-medium rounded-lg text-sm   px-5 py-2.5 text-center dark:bg-main dark:hover:bg-main dark:focus:ring-main mt-5"
        >
          {paymentLoading ? (
